...
parsed = FOREACH ranked_raw {
  record_seq = (long)$0;
  line = (chararray)$1;
  host = REGEX_EXTRACT(line, '^(\\S+)\\s+\\S+\\s+\\S+\\s+\\[(\\S+\\s-\\d{4})\\]\\s+"(\\S+)\\s+(\\S+)(?:\\s+(\\S+))?.*"\\s+(\\d{3})\\s+(\\S+)', 1);
  ts = REGEX_EXTRACT(line, '^(\\S+)\\s+\\S+\\s+\\S+\\s+\\[(\\S+\\s-\\d{4})\\]\\s+"(\\S+)\\s+(\\S+)(?:\\s+(\\S+))?.*"\\s+(\\d{3})\\s+(\\S+)', 2);
  method = REGEX_EXTRACT(line, '^(\\S+)\\s+\\S+\\s+\\S+\\s+\\[(\\S+\\s-\\d{4})\\]\\s+"(\\S+)\\s+(\\S+)(?:\\s+(\\S+))?.*"\\s+(\\d{3})\\s+(\\S+)', 3);
  resource_path = REGEX_EXTRACT(line, '^(\\S+)\\s+\\S+\\s+\\S+\\s+\\[(\\S+\\s-\\d{4})\\]\\s+"(\\S+)\\s+(\\S+)(?:\\s+(\\S+))?.*"\\s+(\\d{3})\\s+(\\S+)', 4);
  protocol = REGEX_EXTRACT(line, '^(\\S+)\\s+\\S+\\s+\\S+\\s+\\[(\\S+\\s-\\d{4})\\]\\s+"(\\S+)\\s+(\\S+)(?:\\s+(\\S+))?.*"\\s+(\\d{3})\\s+(\\S+)', 5);
  status_str = REGEX_EXTRACT(line, '^(\\S+)\\s+\\S+\\s+\\S+\\s+\\[(\\S+\\s-\\d{4})\\]\\s+"(\\S+)\\s+(\\S+)(?:\\s+(\\S+))?.*"\\s+(\\d{3})\\s+(\\S+)', 6);
  bytes_str = REGEX_EXTRACT(line, '^(\\S+)\\s+\\S+\\s+\\S+\\s+\\[(\\S+\\s-\\d{4})\\]\\s+"(\\S+)\\s+(\\S+)(?:\\s+(\\S+))?.*"\\s+(\\d{3})\\s+(\\S+)', 7);
